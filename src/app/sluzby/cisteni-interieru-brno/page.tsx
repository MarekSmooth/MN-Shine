...
export const metadata: Metadata = {
  title: 'Čištění interiéru auta Brno',
  description: 'Profesionální čištění interiéru vozu v Brně a okolí – sedadla, koberce, plasty. Odstranění skvrn, pachů a bakterií. Studio ve Vojkovicích u Brna.',
  ...
  openGraph: {
    ...
    title: 'Čištění interiéru auta Brno | MN Shine Detailing',
...
export default function CisteniInterieru() {
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: 'Čištění interiéru Brno', url: 'https://mnshine.cz/sluzby/cisteni-interieru-brno' },
  ]);
  return (
    <div className="page-pt" style={{ backgroundColor: '#0a0a0a', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '2rem', color: '#FFFFFF', marginBottom: '1.5rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Co zahrnuje čištění interiéru?</h2>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '2rem', color: '#FFFFFF', marginBottom: '1.5rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Proč pravidelně čistit interiér?</h2>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '2rem', color: '#FFFFFF', marginBottom: '1.5rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Postup čištění interiéru</h2>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '2rem', color: '#FFFFFF', marginBottom: '1.5rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Časté dotazy ke čištění interiéru</h2>
        ...
        <div style={{ backgroundColor: '#111111', borderRadius: '0', padding: '2.5rem', textAlign: 'center', border: '1px solid rgba(255,255,255,0.2)' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '1.75rem', color: '#FFFFFF', marginBottom: '1rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Objednejte čištění interiéru</h2>
