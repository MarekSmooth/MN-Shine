...
const faqItems = [
  {
    ...
    answer: 'Délka trvání závisí na kvalitì použitého produktu a péèi o vozidlo. Profesionální keramické povlaky vydrží 2–5 let pøi správné údržbì. Grafenové povlaky mohou vydržet ještì déle. Jednou roènì doporuèujeme aplikaci boost sealantu.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Keramický povlak je chemická vrstva nanášená na lak, která poskytuje hydrofobní efekt, UV ochranu a snadnou údržbu. PPF (Paint Protection Film) je fyzická transparentní fólie, která chrání lak pøed kamínky, škrábanci a mechanickým poškozením. Obì ochrany se doplòují a lze je kombinovat.',
  },
];
...
export default function OchranaLakuPage() {
  const schema = getServiceSchema(
    'Ochrana laku Brno',
    'Profesionální ochrana laku vozidla keramickými povlaky a PPF fólií v Brnì. Hydrofobní efekt, UV ochrana, dlouhodobá ochrana laku.',
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ color: '#9CA3AF', lineHeight: 1.8, marginBottom: '1rem' }}>
            Keramický povlak (ceramic coating) je tekutý polymer na bázi oxidu køemièitého (SiO2) nebo oxidu titanièitého (TiO2), který se chemicky váže na povrch laku a vytváøí tvrdou, ochrannou vrstvu. Na rozdíl od vosku nebo sealantu, keramika nevymývá a vydrží roky.
          </p>
          <p style={{ color: '#9CA3AF', lineHeight: 1.8, marginBottom: '1rem' }}>
            Výsledkem je extrémní hydrofobní efekt – voda, bahno a neèistoty se odvalují z povrchu. Lak je chránìn pøed UV záøením, chemickými látkami (prùmyslový spad, ptaèí trus, hmyz) a lehkými škrábanci.
          </p>
          <p style={{ color: '#9CA3AF', lineHeight: 1.8 }}>
            Vozidlo s keramickou ochranou je výraznì snazší udržovat – neèistoty se nepøilepují a mytí trvá ménì èasu. Lesk laku zùstává zachován na roky.
          </p>
        </section>

        <section style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: "'Big Shoulders Display', sans-serif", fontSize: '2rem', color: '#FFFFFF', marginBottom: '1.5rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Typy ochrany laku</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {[
              ...
              },
              {
                ...
                desc: 'Nejnovìjší generace ochranných povlakù s grafenovými nanoèásticemi. Vyšší tvrdost, lepší teplotní odolnost a delší výdrž než standardní keramika. Vhodný pro luxusní a sportovní vozidla.',
                duration: '3–7 let',
                price: 'od 12 000 Kè',
              },
              {
                ...
                desc: 'Transparentní samoléèící fólie na fyzické poškrábání. Chrání lak pøed kamínky, hmyzem a drobnými nárazy. Lze aplikovat na celé vozidlo nebo jen na exponovaná místa (kapota, nárazníky).',
                duration: '5–10 let',
              ...
              <div key={item.title} style={{ backgroundColor: '#111111', borderRadius: '0', padding: '2rem', border: '1px solid rgba(255,255,255,0.2)', display: 'flex', gap: '1.5rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span style={{ color: '#9CA3AF', fontSize: '0.85rem' }}>Výdrž: <span style={{ color: '#FFFFFF' }}>{item.duration}</span></span>
                </div>
              </div>
            ))}
          </div>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {[
              ...
              'Chemická odolnost – ochrana pøed prùmyslovým spadem, ptaèím trusem a hmyzem',
              'Snadná údržba – zneèištìné vozidlo se mnohem snáze èistí a myje',
              'Zachování lesku – lak si dlouhodobì zachovává hloubku a zrcadlový lesk',
              'Ochrana hodnoty vozidla – chránìný lak se opotøebovává výraznì pomaleji',
            ].map(item => (
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {[
              ...
              { step: '05', title: 'Aplikace keramického povlaku', desc: 'Ruèní aplikace keramiky panel po panelu s dodržením pøedepsaných podmínek.' },
        ...
        <div style={{ backgroundColor: '#111111', borderRadius: '0', padding: '2.5rem', textAlign: 'center', border: '1px solid rgba(255,255,255,0.2)' }}>
          ...
          <p style={{ color: '#9CA3AF', marginBottom: '1.5rem' }}>Konzultujte s námi výbìr správné ochrany pro vaše vozidlo. Rádi vám poradíme a pøipravíme kalkulaci.</p>
